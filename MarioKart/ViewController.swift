...
//      if powerup != nil { // we can use == or != to check ifsomething is nil or not
//          print("Got a powerup!")
//
//      } else {
...
//       }
  ...
  func applySpeedMultiplierSetting(_ settings: [String : Any]) {
      ...
      kartView0.center.x = kartView0.center.x + self.speedMultiplier
      kartView1.center.x = kartView1.center.x + self.speedMultiplier
      kartView2.center.x = kartView2.center.x + self.speedMultiplier
  }
}
